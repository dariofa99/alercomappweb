...
export class InstitutionsInfoComponent implements OnInit {
  ...
  readInstitutionInfoPermission;
  createInstitutionInfoPermission;
  editInstitutionInfoPermission;
  deleteInstitutionInfoPermission;
  ...
  constructor(
    ...
    this.readInstitutionInfoPermission = this.permissionsList.VER_INSTITUCIONES_INFO;
    this.createInstitutionInfoPermission = this.permissionsList.CREAR_INSTITUCIONES_INFO;
    this.editInstitutionInfoPermission = this.permissionsList.EDITAR_INSTITUCIONES_INFO;
    this.deleteInstitutionInfoPermission = this.permissionsList.ELIMINAR_INSTITUCIONES_INFO;
  ...
  addInstitution() {
    this.router.navigate([
      '/home/admin-institutions-info/add-institution-info',
    ]);
  }

  editInstitution(institution: any) {
    this.router.navigate([
      '/home/admin-institutions-info/edit-institution-info/' + institution.id,
    ]);
  }
