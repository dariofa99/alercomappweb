...
export class InstitutionsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.institutions.forEach(element => {
      this.institutionsToDisplay.push(new InstitutionToDisplay(element.id,element.institution_name,
  ...
  editInstitution(institution: any){
    this.router.navigate(["/home/admin-institutions/edit-institution/"+institution.id]);
  }
